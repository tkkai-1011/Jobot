...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="search">
  ...
  <form action="fetch.htm" method='post'>
        <button class="w3-button w3-black" type="submit">
          <i class="fa fa-paper-plane"></i> See saved Jobs!
        </button>
      </p>
    </form>
  ...
  <div style="margin-top:48px">
    <form action="option.htm" method='post'>
      <p><input class="w3-input w3-border" type="text" placeholder="Software Internship/Fulltime" required name="keyword"></p>
        <button class="w3-button w3-black" type="submit">
          <i class="fa fa-paper-plane"></i> Let's Search!
        </button>
      </p>
    </form>
  </div>
